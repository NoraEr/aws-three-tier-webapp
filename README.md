...
## Deployment steps
- Setup: Created S3 bucket. Upload code for the application into S3. Setup IAM role required by EC2 instance
...
- Load balancing and auto-scaling: To maintain high availability, configure external and internal application load balancers. To ensure horizontal scalability, deployed auto-scaling groups with a minimum capacity of two instances.
